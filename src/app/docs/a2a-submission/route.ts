...
A2A Agent Card -> POST /api/a2a/message-send -> handleSendMessage -> runConversationAgent -> runProfessionalAdvisor -> Chief Advisor -> specialist agents -> server-side publication gate -> A2A task.
