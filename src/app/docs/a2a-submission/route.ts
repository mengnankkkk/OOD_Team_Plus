const DOCUMENT = `# A2A Remote Agent Submission
...
A2A Agent Card -> POST /api/a2a/message-send -> handleSendMessage -> runConversationAgent -> runProfessionalAdvisor -> Chief Advisor -> Profile Context -> Data Research -> Portfolio Risk -> Recommendation -> Compliance Reviewer -> Explanation Report -> server-side publication gate -> A2A task.
