...
export function GeneratedArtifactDetailPage() {
  ...
  async function remove() {
    ...
    try { await apiMutation(`/api/v1/generated-artifacts/${id}`, "DELETE", undefined, { "If-Match": String(detail.data.currentVersion) }); navigate("/assets"); } catch (error) { toast.error(error instanceof Error ? error.message : "删除失败"); }
  }
