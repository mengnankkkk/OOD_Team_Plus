...
function MarkdownPreview({ markdown }: { markdown: string }) {
  ...
  while (index < lines.length) {
    ...
    else if (line.startsWith("- ")) blocks.push(<p className="markdown-bullet" key={index}><span className="markdown-bullet-icon">•</span><span className="markdown-bullet-content">{renderInlineMarkdown(line.slice(2))}</span></p>);
